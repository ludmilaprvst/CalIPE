...
def C1C2_ponderation_mag_class(obsbin_plus):
    ...
    for bins in mag_bins_df:
        ...
        tous_les_poids =  1/(obsbin_gp_tmp['StdM'].values**2)
        obsbin_plus.loc[ind, 'poids_evt_StdM'] = obsbin_plus.loc[ind, 'poids_evt_StdM']/sum(tous_les_poids)
        obsbin_plus.loc[ind, 'poids_class'] = obsbin_plus.loc[ind, 'poids_indiv']*obsbin_plus.loc[ind, 'poids_evt_StdM']
        obsbin_plus.loc[ind, 'poids_class'] = obsbin_plus.loc[ind, 'poids_class']/obsbin_plus.loc[ind, 'poids_class'].sum()

        
    obsbin_plus.loc[:, 'poids'] = obsbin_plus.loc[:, 'poids_class']/len(mag_bins_df)
